...
public class MongoConfig
{
	...
	static
	{
		try
		{
			...
			StringOption MONGO_HOST = new StringOption( "mongo.host", "192.168.59.103", true, "MONGO server host" );
	...
	public MongoClient getClient()
	{
		if(client == null) {
			...
			try {
				MongoCredential credential = MongoCredential.createMongoCRCredential(mongoUsername, mongoAuthDB, mongoPassword.toCharArray());
