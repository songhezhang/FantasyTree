...
public class LDAPStorageHandler implements StorageHandler
{
	...
	public LDAPStorageHandler()
	{
		...
		try
		{
			...
			StringOption	LDAP_ADDRESS				= new StringOption( "ldap.address", "ldap://192.168.59.103:389", true, "LDAP server address" );
			StringOption	LDAP_CREDENTIAL_DN			= new StringOption( "ldap.bindDN", "cn=Manager,dc=fantasystep,dc=com", true, "LDAP credentials DN" );
			StringOption	LDAP_CREDENTIAL_PASSWORD	= new StringOption( "ldap.bindPassword", "welcome0", true, "LDAP credentials password" );
